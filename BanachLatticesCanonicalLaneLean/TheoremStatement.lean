import BanachLatticesCanonicalLaneLean.ReviewerBridge
...
def sourceTheoremStatement : TheoremStatement := {
  ...
  theoremObject := "Banach Lattices: Order structure and norm completeness",
  classicalBoundary := "Unrestricted classical boundary carried by formalization certificate",
  manifoldConstrainedStatement := "Banach lattice theorem certificate internalized through baseline gates, source constants, reviewer bridge, manifest hashes, and outside-constant dependency count",
